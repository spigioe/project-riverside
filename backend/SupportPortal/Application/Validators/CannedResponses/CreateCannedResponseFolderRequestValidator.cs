...
public class CreateCannedResponseFolderRequestValidator : AbstractValidator<CreateCannedResponseFolderRequest>
{
    public CreateCannedResponseFolderRequestValidator()
    {
        RuleFor(x => x.Name)
